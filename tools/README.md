...
# Preemption-context tooling

`test-preemption-context` uses isolated build/output directories and a strict
serial-log validator. It is included in `check-all` and the x86-64 smoke
workflow alongside the eight existing QEMU tests.
