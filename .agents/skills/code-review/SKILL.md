...
1. Verify claimed baseline and issue scope
2. Trace inputs, ownership, errors, rollback, and concurrency
3. Audit integer/pointer/unsafe and architecture assumptions
4. Evaluate tests against failure modes
5. Report findings by severity with paths/lines
...
- [ ] The workflow proves `Verify claimed baseline and issue scope` before relying on downstream assumptions.
