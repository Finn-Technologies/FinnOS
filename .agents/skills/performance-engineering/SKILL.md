...
status: "active"
owners: []
triggers: ["benchmark","latency","boot time","performance"]
prerequisites: ["test-strategy","evidence-status-reporting"]
...
description: "Use when working on benchmark, latency, boot time; provides the FinnOS-specific performance engineering workflow and evidence gates."
---
...
1. Define workload/environment/metric and warmup
2. Capture distributions and resource counters
3. Profile before code changes
4. Set evidence-based regression threshold
5. Compare x86/ARM semantics without assuming equal hardware
...
- [ ] The workflow proves `Define workload/environment/metric and warmup` before relying on downstream assumptions.
