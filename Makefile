.PHONY: help doctor build check test format format-check lint agent-check test-heap test-timer-interrupts test-cooperative-tasks test-preemption-context
...
test-preemption-context:
	./tools/finn test-preemption-context
